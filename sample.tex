...
Manage a \textbf{team of 6 engineers and doctors}, as well as several PhD students.
Plan the long term roadmap of the team and leading the collaboration with \textbf{several research laboratories (Inria) and industrial units}.

In particular, manage projects on:
\begin{itemize}
\item \textbf{Productivity User Study}: Perform quantitative and qualitative analyses to assess the impact of new tools and approaches on developers.
...
\cvevent{Ph.D. Software Engineer}{Inria RMoD/Berger-Levrault}{Mars 2018 -- October 2021}{Montpellier/Lille, France}

\begin{itemize}
  \item Migrating GWT applications to Angular
  \item Set up hybrid architecture (mixing GWT and Angular)
  \item Analyse applications architecture
  \item Writing research papers
  \item Teaching
\end{itemize}
...
Planned the team’s long-term roadmap and \textbf{steered collaboration with multiple research laboratories (Inria)} and industrial units.
