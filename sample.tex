...
\item \textbf{Code cartography}: Representing code with maps to understand, plan, and modernize very large-scale applications
\end{itemize}
...
\begin{itemize}
\item GreenIT: Measuring the energy consumption of infrastructure and code
\item AI for code: Integrating AI into Merge Requests and IDEs; using MCP and tool-calling features; integrating new tool-calling in IDEs; measuring the real impact on production teams
\item Code cartography: Representing code with maps to understand, plan, and modernize very large-scale applications
\end{itemize}

Also managing a team of 5 researchers and engineers, as well as several PhD students
And leading the collaboration with several research laboratories (Inria) and industrial units.
